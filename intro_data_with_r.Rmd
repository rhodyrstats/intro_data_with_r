...
Before we get our data into R, let's take a look at the data in the Sheet.  [Click here](https://docs.google.com/spreadsheets/d/1U-78sk0bx0J7PD30NTe5wq8ZYtgceT1jtxB7yyhQHPY/) to see the data we are working with.
...
```{r}
alldata <- read.csv("NarrBay_countdata_7.31.2018.csv") #note have to download
